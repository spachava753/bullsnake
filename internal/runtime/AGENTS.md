...
Native integer, string, and dictionary subclasses retain typed native payloads separately
from their Python attributes. Their cached native namespace chain follows Python
MRO lookup; explicit native descriptors bypass overrides. Compatible integer/string
