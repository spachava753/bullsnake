...
strings, bytes, fixed tuples and lists, dictionaries, slices, sequence
...
unpacking, tuple/list iteration and subscription, fixed dictionary displays,
and dictionary subscription and item mutation. Dictionary key matching is
linear until user-defined hash and equality protocols justify a hash table.
