...
truth, numeric unary operators, selected arbitrary-precision integer binary
operators, scalar equality and ordering, and object identity. Later user-defined
