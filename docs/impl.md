...
names, number spellings, binary expressions, comparison chains, positional
...
nested `IfStmt` alternatives. Loops, power and unary interaction, conditional
expressions, lambdas, comprehensions, assignment expressions, and formatted
strings remain future grammar slices.
...
The initial corpus contains eleven successful AST cases and six failures.
