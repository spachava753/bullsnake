...
`RuntimeError`. Set instances expose a bound `add` method using the same fixed
hashability and equality rules as set displays. Set-like view operations and
other native collection methods are not implemented yet. Lists compare
structurally
