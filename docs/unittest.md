...
| `enum` | `enum.py:1022:29`: missing `None.__new__` while selecting native allocators. |
...
provide real NoneType and object allocation operations and descriptors.
