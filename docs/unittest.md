...
| `enum` | `enum.py:499:25`: native set intersection (`&`) is unsupported. |
...
implement native set operators used by EnumType's member-name validation.
