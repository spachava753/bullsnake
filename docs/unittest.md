...
| --- | --- |
| `types`, `enum` | `types.py:345:23`: missing `globals()` builtin. |
...
implement the live globals() builtin needed by types' export discovery.
