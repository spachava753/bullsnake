...
Function.__get__ now creates actual bound methods, preserves function/receiver
identity, supports unbound class access, and validates direct calls. Tests also
check that function attribute overrides do not replace special descriptor binding.
