...
| `enum` | `enum.py:1398:1`: unpacking FlagBoundary requires metaclass iteration; member descriptor naming hooks are also missing. |
...
implement descriptor naming hooks and metaclass iteration, then follow later Enum
