...
| `enum` | `enum.py:79:15`: string percent formatting is unsupported in _is_private. |
...
implement string percent formatting needed by EnumDict member-name validation.
